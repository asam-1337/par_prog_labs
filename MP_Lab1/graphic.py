...
def show_graph():
    ...
    compares_list = read_file("compares.txt")
    ...
    compares_list = create_points_lists(1, compares_list)
    ...
    plt.subplot(111)
    plt.figure(figsize=(12, 7))
    plt.plot(thread_num_list, compares_list, marker="o", c="b")
    plt.title(r'Compares graph')
    plt.xlabel("Num threads", fontsize=14)
